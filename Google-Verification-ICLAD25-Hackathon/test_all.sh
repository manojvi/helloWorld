...
# Define the specific problems you want to run
#TARGET_PROBLEMS=("shift_left" "shift_right" "fifo_flops")
TARGET_PROBLEMS=("counter"  "credit_receiver"  "ecc_sed_encoder"  "enc_bin2gray"  "enc_bin2onehot"  "fifo_flops"  "lfsr"  "shift_left"  "shift_right" "cdc_fifo_flops_push_credit")
...
echo "Starting evaluation for specified problems..."

# Loop through each of the target problems
for problem_name in "${TARGET_PROBLEMS[@]}"; do
  problem_dir="$PROBLEMS_PARENT_DIR/$problem_name"
